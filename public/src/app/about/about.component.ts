...
export class AboutComponent implements OnInit {
  ...
  aboutContent = [
    ...
    "Received my B.A. in Psychology and I worked in Social Work for the past 8 years. Working with lower-income older adults made me realize the importance of familiarity with modern technologies to avoid social isolation. This is what sparked the idea about going into this field to build apps to help others.",
    "As you probably have already guessed, I'm a huge basketball fan. I try to get on the court at least twice a week, while I still can. I also catch as many Lakers games as I can. Other than that, I love just relaxing and watching TV with my wife Laura. (We got married in Lake Arrowhead -- hence, the gif)",
  ]
