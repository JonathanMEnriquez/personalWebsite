...
export class CodeComponent implements OnInit {
  ...
  angularContent: String = "I learned the Angular framework as part of the third stack of my curriculum (MEAN Stack). This front-end of this site was built using Angular, include their Material components (in addition to using Materialize). What I most like about the framework is the structure that allows for multiple front-end contributors. The lightening of the burden on the server is also great."
  ...
  iosContent: String = "The iOS stack was definitely the most enjoyable for me. Between the hackathons and the cool tools at my disposal, it was non-stop challenges. We won both of our hackathons and I also had the chance to present a project using Apple's Multipeer Connectivity, which was great. Following the bootcamp, I have continued working on Runner's HIIE, which is a running interval training app that we hope to submit for App Store approval in the coming weeks. I will also be working on a party-game app for the Apple Watch in the coming weeks, as well."
